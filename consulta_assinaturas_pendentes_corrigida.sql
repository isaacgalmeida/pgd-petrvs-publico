-- ============================================================================
-- CONSULTA: Planos de Trabalho com Assinatura Pendente
-- ============================================================================
-- OBJETIVO: Identificar planos de trabalho com status AGUARDANDO_ASSINATURA 
-- ou INCLUIDO e calcular se a assinatura está pendente há mais de 30 dias
--
-- CORREÇÃO APLICADA: Removido JOIN com tipos_modalidades (tabela inexistente)
-- e substituído por coluna modalidade_pgd diretamente de planos_trabalhos
--
...
FROM (
    ...
    FROM
        ...
        -- A coluna modalidade_pgd agora está diretamente em planos_trabalhos
        -- ====================================================================
    WHERE
...
WHERE
    ...
    OR (`__mb_source`.`status` = 'INCLUIDO')
ORDER BY
    `__mb_source`.`usuarios - usuario_id__nome` ASC
LIMIT 1048575;
